            ...
            <div class="card-body">
                ...
                <b-row>
                    ...
                    <b-modal id="modalAdd" @hide="resetAddProjModal" @ok="addProject" title="New Project">
                        ...
                        <v-selector :model="newProject.usedSkills" :model-options="skills" value-key="id" text-key="name"></v-selector>
                    </b-modal>                
                </b-row>               
            </div>
        </div>
...
export default {
  ...
  methods:{
    ...
    addProject(evt){
      ...
      axios
        .post(
          "http://es-workspace-mikhails85.c9users.io:8081/api/employees/"+this.id+"/addproject",
          {
            EmployeeId:this.id,
    ...
    refreshProjects(){
        axios
          ...
          .then(r => {
            ...
            this.employee.projects = r.data.value;            
          });
    }
  },
  mounted() {
